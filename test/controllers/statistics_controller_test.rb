...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { recieved_messages: @statistic.recieved_messages, sended_messages: @statistic.sended_messages, user_id: @statistic.user_id }
    end
  ...
  test "should update statistic" do
    patch :update, id: @statistic, statistic: { recieved_messages: @statistic.recieved_messages, sended_messages: @statistic.sended_messages, user_id: @statistic.user_id }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
